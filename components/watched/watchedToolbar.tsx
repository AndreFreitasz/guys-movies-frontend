...
export interface WatchedSortOption<T extends string> {
  key: T;
  label: string;
}

interface WatchedToolbarProps<T extends string> {
  query: string;
...
const WatchedToolbar = <T extends string>({
  query,
  onQueryChange,
  searchPlaceholder,
  searchAriaLabel,
