...
const Avatar: React.FC<AvatarProps> = ({
  ...
  return (
    <span
      aria-hidden="true"
      className={`${SIZES[size]} inline-flex items-center justify-center rounded-full border border-white/15 bg-gradient-to-br ${avatarGradient(username)} font-black tracking-tight text-white shadow-lg`}
    >
