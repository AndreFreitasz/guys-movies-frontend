  ...
  return (
    <>
      <div className="relative group cursor-pointer" key={id}>
        ...
        />
        <div className="absolute inset-0 flex flex-col justify-center items-center opacity-0 group-hover:opacity-100 transition-opacity duration-300 bg-gradient-to-t from-black via-transparent to-transparent rounded-lg p-4 w-80 h-50">
