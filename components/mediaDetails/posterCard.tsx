    ...
    return (
      <div className="group relative overflow-hidden rounded-3xl border border-white/10 bg-black/20 shadow-2xl shadow-indigo-900/40 backdrop-blur">
        ...
        <button
          ...
          disabled={isLoading}
          className={`group/button absolute right-4 top-4 hidden items-center gap-2 rounded-full px-4 py-2 text-sm font-semibold uppercase tracking-wide backdrop-blur transition lg:flex ${
            isInWatchlist
